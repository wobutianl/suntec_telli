...
public class RoundProgressBar extends View {
	...
	public RoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
		...
		roundColor = mTypedArray.getColor(
				R.styleable.RoundProgressBar_roundColor, Color.WHITE);
...
//		centerRes = BitmapFactory.decodeResource(getContext().getResources(), mTypedArray.getResourceId(i, R.drawable.ic_launcher));
		mTypedArray.recycle();
	}
